...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{Typical errors in the matrices used to compute the flux (\autoref{eq:starry}) with \textsf{starry} and \textsf{jaxoplanet}. \codelink{workflows/precision/scripts/plot_error_SAR}}
