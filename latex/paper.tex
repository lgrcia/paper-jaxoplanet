...
\begin{itemize}
    ...
    \item The \texttt{jaxoplanet.light\_curves.emission} module contains functions to compute light curves of emissive limb darkened bodies. This module usess the same formalism as the \texttt{limbdark} module, but allows for secondary ecclipses to be computed.
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{Typical errors in the matrices involved in the computation of the flux from \autoref{eq:starry}. \codelink{workflows/precision/scripts/plot_error_SAR}}
