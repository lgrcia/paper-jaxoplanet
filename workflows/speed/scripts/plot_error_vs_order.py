...
plt.subplot(121)
plt.plot(orders, jax_times_quadratic * 1e3, ".-", label="jaxoplanet (CPU)")
plt.plot(orders, jax_times_quadratic_gpu * 1e3, ".-", label="jaxoplanet (GPU)")
...
plt.plot(orders, jax_times_l20_gpu * 1e3, ".-", label="jaxoplanet (GPU)")
